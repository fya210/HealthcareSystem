...
import FileUploader from "../../storage.mjs";
...
userRouter
  .route("/:username/photos/:id")
  .get(UserCtrl.getPhoto)
  .delete(UserCtrl.deletePhoto);

userRouter
  .route("/:username/degrees")
  .get(UserCtrl.getDegrees)
  .post(UserCtrl.addDegree);

userRouter.route("/:username/degrees/:id").delete(UserCtrl.deleteDegree);

userRouter.route("/:username/jobs").get(UserCtrl.getJobs).post(UserCtrl.addJob);

userRouter.route("/:username/jobs/:id").delete(UserCtrl.deleteJob);
...
userRouter
  .route("/:username/insurances")
  .get(UserCtrl.getInsurances)
  .post(UserCtrl.addInsurance);

userRouter.route("/:username/insurances/:id").delete(UserCtrl.deleteInsurance);

userRouter.route("/:username/payments").get(UserCtrl.getPayments);

userRouter.route("/:username/labReports").get(UserCtrl.getReports);
